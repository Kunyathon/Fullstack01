...
.custom-style {
  ...
  overflow: hidden;
  width: 100%;
  /* background: radial-gradient(ellipse at bottom, #1b2735 0%, #141a24 70%); */
  background: linear-gradient(to bottom, #263c5c 0%, #111425 82%);
  height: 30vh;
}
...
#stars, #stars2, #stars3 {
  ...
  width: 100%;
  height: 100%;
  pointer-events: none; /* ป้องกันไม่ให้การคลิกกระทบกับการเลื่อน */
}
